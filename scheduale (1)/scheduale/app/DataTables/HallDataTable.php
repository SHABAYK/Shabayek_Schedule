...
class HallDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'Hall.btn.checkbox')
            ->addColumn('edit', 'Hall.btn.edit')
            ->addColumn('delete', 'Hall.btn.delete')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
    ...
    public function html()
    {
        ...
        ->parameters([
            ...
            'buttons'=>[
                ['text'=>'<i class="fa fa-plus"></i> Create Hall', 'className'=>'btn btn-info',
                    "action"=>"function(){

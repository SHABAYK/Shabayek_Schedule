...
class YearDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'Year.btn.checkbox')
            ->addColumn('edit', 'Year.btn.edit')
            ->addColumn('delete', 'Year.btn.delete')
    ...
    public function html()
    {
        ...
        ->parameters([
            ...
            'buttons'=>[
                ['text'=>'<i class="fa fa-plus"></i> Create Year', 'className'=>'btn btn-info',
                    "action"=>"function(){

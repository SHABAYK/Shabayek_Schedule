...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2018 at 02:48 PM
...
INSERT INTO `doctors` (`id`, `user_id`, `dept_id`, `hiring_info_id`, `created_at`, `updated_at`) VALUES
(1, 17, 7, 1, '2018-04-05 12:23:48', '2018-04-05 12:23:48'),
(3, 20, 2, 2, '2018-04-05 14:38:24', '2018-04-05 12:38:24');
...
INSERT INTO `faculty_courses` (`id`, `dept_id`, `prerequisite_id`, `research_area_id`, `title`, `credit_hours`, `created_at`, `updated_at`) VALUES
(5, 2, 5, 1, 'Data Mining', 3, '2018-04-03 13:41:56', '2018-04-03 13:47:43'),
(6, 2, 6, 2, 'Quality', 3, '2018-04-03 13:49:14', '2018-04-03 13:49:29'),
(7, 9, NULL, 3, 'Data Structure', 3, '2018-04-07 16:58:30', '2018-04-07 16:58:30'),
(8, 2, NULL, 1, 'Internet Application', 3, '2018-04-07 17:10:32', '2018-04-07 17:10:32');
...
CREATE TABLE `hiring_info` (
  `id` int(11) NOT NULL,
  `hiring_degree` enum('master','doctor','assistant professor','co professor','professor') DEFAULT NULL,
  `hiring_date` date DEFAULT NULL,
  `last_degree` enum('master','doctor','assistant professor','co professor','professor') DEFAULT NULL,
  `last_date` date DEFAULT NULL,
  `lastest_degree` enum('master','doctor','assistant professor','co professor','professor') DEFAULT NULL,
...
(1, 'assistant professor', '2018-04-06', 'doctor', '2014-05-20', 'master', '2010-05-15', '2018-04-05 11:44:23', '2018-04-05 12:00:09'),
(2, 'doctor', '2018-04-05', 'master', '2014-04-05', NULL, NULL, '2018-04-05 11:45:24', '2018-04-05 12:01:55'),
(3, 'master', '2018-09-10', NULL, NULL, NULL, NULL, '2018-04-05 12:02:29', '2018-04-05 12:02:29');
...
(1, 1, 'Ahmed Badwi', 'admin@admin.com', '$2y$10$ti/WeDcls66V6AWgTPN.EO0tSemJpBFqLmhbbS.vpKCUqC6VbgW1G', 10000, 'admin', 'CYYoUl5WkGYIiJPNSRljWlRePZU3PzUpj5ytVFhZ3Ogp2g04POrJ4u0udY5e', '2018-03-31 16:51:07', '2018-03-31 16:51:07'),
...
(7, 2, 'Ali Nagi', 'ali@manager.com', '$2y$10$DIGHh87JZdNE5LaWMRljheWhDiWoCeGh99NDkYaYEJq4O7F5uc34S', 123456, 'manager', 'IeS3BBh4Z0Aya6hitEZ7Tq9euayQQH0N5hxT1YF2WFxndkxF7hFsr8bIQWg6', '2018-04-01 14:07:11', '2018-04-03 14:32:23'),

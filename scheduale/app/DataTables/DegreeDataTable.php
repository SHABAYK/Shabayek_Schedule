...
class DegreeDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'Degree.btn.checkbox')
            ->addColumn('edit', 'Degree.btn.edit')
            ->addColumn('delete', 'Degree.btn.delete')
            ->addColumn('doctor_name', 'Degree.btn.doctor_name')
            ->addColumn('research_area', 'Degree.btn.research_area_name')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
    ...
    public function html()
    {
        ...
        ->parameters([
            ...
            'buttons'=>[
                ['text'=>'<i class="fa fa-plus"></i> Create Degrees', 'className'=>'btn btn-info',
                    "action"=>"function(){
